...
# ==========================
data = np.load('backtranslation_data.npz')
T = int(data['T'])
...
print(f"Mean change probability (back-translation): {change_prob.mean():.4f}")
...
plt.tight_layout()
plt.savefig('BackTranslation-prob.png', dpi=300, bbox_inches='tight')
plt.show()